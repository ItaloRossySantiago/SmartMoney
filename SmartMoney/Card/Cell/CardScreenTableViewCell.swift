...
class CardScreenTableViewCell: UIView {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            cardImageView.topAnchor.constraint(equalTo: topAnchor, constant: 5),
            ...
            cardNameLabel.centerYAnchor.constraint(equalTo: cardImageView.centerYAnchor, constant: 5),
            cardNameLabel.leadingAnchor.constraint(equalTo: cardImageView.trailingAnchor, constant: 10),
            
            deleteImageView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
            deleteImageView.centerYAnchor.constraint(equalTo: cardNameLabel.centerYAnchor),
            ...
            editImageView.centerYAnchor.constraint(equalTo: cardNameLabel.centerYAnchor),
