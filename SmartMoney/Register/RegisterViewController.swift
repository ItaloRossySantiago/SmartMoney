   ...
   // CLOUSURES
    ...
    var onReturnToLogin:(() -> Void)?
        ...
        func setupUI() {
            ...
            loadingLabel.text = "Aguarde criando o seu usuário"
        ...
        func startLoading() {
            // Show the activity indicator and disable user interaction
            setupUI()
        ...
        func stopLoading() {
            // Hide the activity indicator and enable user interaction
